...
const overridesFromPlanUpdates: WeeklyPlanByUser = {
  K: {
    ...
    Tuesday: {
      ...
      snack2: meal("Snack 2", ["30g cashews"]),
      meal3: meal("Meal 3 - Salmon", ["125g salmon fillet", "Lemon", "Black pepper", "175g sweet potato wedges", "80g green beans"]),
    },
    Wednesday: {
      ...
      meal3: meal("Meal 3 - Red Pesto Cod", ["200g cod loin", "30g reduced-fat red pesto", "100g mixed green vegetables", "150g sweet potato wedges"]),
    },
    Thursday: {
      meal1: meal("Meal 1 - Oats", ["55g wholegrain rolled oats", "250ml almond milk", "1/2 scoop Purition", "75g blueberries", "1 tsp chia seeds"]),
      snack1: meal("Snack 1", ["1 banana", "200ml almond milk", "1/2 scoop Purition"]),
  ...
  C: {
    ...
    Tuesday: {
      ...
      meal3: meal("Meal 3 - Salmon", ["125g salmon fillet", "Lemon", "Black pepper", "125g cooked basmati rice", "75g green beans", "25g reduced-fat feta"]),
    },
    Wednesday: {
      ...
      meal3: meal("Meal 3 - Red Pesto Cod", ["200g cod loin", "30g reduced-fat red pesto", "100g mixed green vegetables", "200g sweet potato wedges"]),
    },
    Thursday: {
      meal1: meal("Meal 1 - Oats", ["62.5g wholegrain rolled oats", "300ml almond milk", "10g peanut butter", "1/2 scoop Purition", "75g blueberries", "1 tsp chia seeds"]),
      snack1: meal("Snack 1", ["1 banana", "200ml almond milk", "1/2 scoop Purition"]),
      meal2: meal("Meal 2", ["150g chicken breast", "100g green vegetables", "3 tsp mild piri piri", "125g Tilda brown basmati rice"]),
      snack2: meal("Snack 2", ["1 apple", "25g cashews"]),
      meal3: meal("Meal 3 - Salmon", ["125g salmon fillet", "Lemon", "Black pepper", "105g cooked basmati rice", "75g green beans", "25g reduced-fat feta"]),
    },
    Friday: {
